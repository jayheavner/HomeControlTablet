  ...
  <div v-if="tracks" class="tracks-list">
    ...
    >
      ...
      <div class="tracks-list__cell tracks-list__cell--index">
        <span class="tracks-list__cell-index">
          {{ index + 1 }}
        </span>
        <track-playback
          :track-uri="item.uri"
      ...
      <div
        v-if="item.artists && showArtists"
        class="tracks-list__cell tracks-list__cell--name"
      >
        <router-link
      ...
      <div
        v-if="item.album && showAlbum"
        class="tracks-list__cell tracks-list__cell--name is-hidden-touch"
      >
        <router-link
          class="tracks-list__link"
      ...
      <div
        class="tracks-list__cell tracks-list__cell--duration is-hidden-touch"
      >
        {{ item.duration_ms | msToMinutes }}
      </div>

      <div class="tracks-list__cell tracks-list__cell--name is-hidden-touch">
        {{ item.popularity }}
      </div>
    </div>
  </div>
...
.tracks-list
  ...
  &__row
    ...
    font-size: 13px
    line-height: 15px
    border-bottom: 1px solid $c-soft-grey

    &:first-of-type
      border-top: 1px solid $c-soft-grey
